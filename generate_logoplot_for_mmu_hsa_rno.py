...
'''
'''
project_name= GCcalc_for_logoplot_generating
'''
# 1. generate unique seed region for miRNA from mature.fa data for species code (mouse,Rat and human)  
# 2. generate logoplot by adding logger method for all species code (mouse, Rat and human)
...
def main(argv=None):
    ...
    global speciesCode
    speciesCode = "rno" #add the three specific species code
    global filename
    global seedBegin
    global seedEnd
    seedBegin = 2
    ...
    print(uniqSeedSeqs)
    dfFreqs = getNucleotideFrequencyMatrix(uniqSeedSeqs)
    print(dfFreqs)
    generateLogoPlot(dfFreqs)
